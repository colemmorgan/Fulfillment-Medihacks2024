      ...
      <div className="px-10 mt-20 pb-32">
        <div className="relative z-20 text-center flex flex-col justify-center">
          ...
          <div className="mt-5 flex justify-center gap-4  pl-2">
            <Link to={"/courses"}>
              <button className="semibold text-xl bg-opaque pt-2.5 pb-1.5 w-44 rounded-full">
                Courses
              </button>
            </Link>
           <Link to={"/login"}>
          ...
          <div className="p-7 pt-0 border border-borderColor rounded-2xl max-w-[1164px] mx-auto mt-16 bg-[#f2f4f5]">
            <div className="w-full h-8 flex justify-start items-center space-x-2 px-3 ">
              <span className="w-2.5 h-2.5 rounded-full bg-red-400"></span>
              <span className="w-2.5 h-2.5 rounded-full bg-yellow-400"></span>
              <span className="w-2.5 h-2.5 rounded-full bg-green-400"></span>
            </div>
            <figure className="max-w-[1100px] mx-auto  rounded-xl overflow-hidden border border-borderColor">
